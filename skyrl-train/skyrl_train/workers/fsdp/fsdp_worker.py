    ...
    def init_model(self, model_path, num_training_steps: int = None):
        ...
        with init_context():
            ...
            wrapped_model = HFModelWrapper(
                ...
                lora_init_method=self.cfg.trainer.policy.model.lora.get("init_method", "default"),
    ...
    def init_model(self, model_path, num_training_steps: int = None):
        ...
        with init_context():
            critic = get_llm_for_sequence_regression(
                ...
                lora_init_method=self.cfg.trainer.critic.model.lora.get("init_method", "default"),
                target_modules=self.cfg.trainer.target_modules,
